...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Name of the input raw data artifact in W&B (e.g. 'sample.csv:latest')",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Name of the cleaned data artifact to create and log to W&B",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "Type of the cleaned data artifact (e.g. 'clean_data')",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "Short description of the cleaned data artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Minimum allowed listing price; rows with lower price will be dropped",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Maximum allowed listing price; rows with higher price will be dropped",
        required = True
    )
